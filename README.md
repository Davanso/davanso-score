...
Livestream score website

## 🚀 Features

- - **Real-time Score Updates**: Display live scores for ongoing matches with instant updates.
- **Match Details**: View detailed statistics and information about matches, teams, and players.
- **Customizable Dashboard**: Users can personalize their dashboard to view specific matches or teams.
- **Notification System**: Get notifications for goals, match starts, ends, or other important events.
- **Responsive Design**: Fully optimized for mobile, tablet, and desktop viewing.
- **Dark/Light Mode**: Toggle between themes for better user comfort.
